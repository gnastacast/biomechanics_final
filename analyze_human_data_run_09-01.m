...
%%
if ~exist("skeleton", "var") || skeleton.Subject ~= 09
    skeleton = MoCapTools.Skeleton("MoCapData/09.asf");
    skeleton.AddMotion("MoCapData/09_01.amc");
    skeleton.AddMotion("MoCapData/09_02.amc");
    skeleton.AddMotion("MoCapData/09_03.amc");
    skeleton.AddMotion("MoCapData/09_04.amc");
    skeleton.AddMotion("MoCapData/09_05.amc");
end
trial_no = 2;
...
min_vel = 1;
max_position = [inf, 0.2, inf];
smoothing_time = 0.1;

[vels, liftoff, landing, fp, times] = analyze_data(t, xyz_COG, xyzFP, n_legs, ...
                                                   min_vel, max_position, ...
                                                   smoothing_time, true);
% axis equal
% legend([""])
...
for i = 1:2:skeleton.MotionData(trial_no).Frames
    [G, xyz] = graphSkeleton(skeleton, trial_no, i);
    plot(G, XData=xyz(:,data_order(1)), YData=xyz(:,data_order(2)), ...
